...
##Usuario 
**Emergency Cipher** está dirigido a un público femenino que se encuentra en una situación de peligro, donde deben enviar un mensaje de emergencia que debe ser interpretado únicamente por usuarios que utilicen la plataforma al cifrar/descifrar el texto.

##Objetivo
Ofrecer una solución efectiva, que sea rápida y sencilla, donde el mensaje que se desee emitir pueda ser entendido únicamente por usuarios de la plataforma y que tengan la clave en común.
...
###Ejemplo:
Por ejemplo, si usamos un desplazamiento (Clave) de 2 posiciones:
